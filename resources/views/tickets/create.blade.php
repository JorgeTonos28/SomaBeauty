<x-app-layout>
    ...
    <div x-data="ticketForm()" class="py-6 max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <form x-ref="form" action="{{ route('tickets.store') }}" method="POST" @submit.prevent="submitForm" class="space-y-6">
            @csrf
            ...
            <!-- Botón y Resumen -->
            <div class="flex items-center gap-6 mt-4 fixed bottom-0 left-0 right-0 bg-white p-4 shadow z-10 max-w-4xl mx-auto">
