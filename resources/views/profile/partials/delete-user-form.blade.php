<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Una vez que tu cuenta sea eliminada, todos sus recursos y datos se eliminarán permanentemente. Antes de borrarla, descarga la información que desees conservar.
        </p>
    </header>
