        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-6 shadow sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" required class="form-input w-full rounded border-gray-300 shadow-sm mt-1">
                </div>
                <div class="mb-4">
                    <label for="password" class="block font-medium text-sm text-gray-700">Contraseña</label>
                    <input type="password" name="password" id="password" required class="form-input w-full rounded border-gray-300 shadow-sm mt-1">
                </div>
                <div class="mb-4">
                    <label for="password_confirmation" class="block font-medium text-sm text-gray-700">Confirmar Contraseña</label>
                    <input type="password" name="password_confirmation" id="password_confirmation" required class="form-input w-full rounded border-gray-300 shadow-sm mt-1">
                </div>
                <div class="mb-4">
